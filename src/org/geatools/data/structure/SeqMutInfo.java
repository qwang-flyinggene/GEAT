...
public class SeqMutInfo {
	 
	  public String expName;
	  public String seqName;
	  public int readsNum;
	  public String seq;
	  public BaseMutStat []baseMutStat;
	  public double avgMutRate;
	  public double avgTarMutRate;	
	  public double avgOtherMutRate;
	  public double sumMutRate;
